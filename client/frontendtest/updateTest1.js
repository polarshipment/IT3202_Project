...
async function updateProduct(driver) {
  try {
    ...
    await clearAndEnterText(productNameInput, 'Updated Product', 50);
    ...
    await clearAndEnterText(productStockInput, '50', 50);
    ...
    await clearAndEnterText(productPriceInput, '60.99', 50);
